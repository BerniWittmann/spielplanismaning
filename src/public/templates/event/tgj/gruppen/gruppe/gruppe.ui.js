(function () {
    ...
    function states($stateProvider) {
        $stateProvider
            .state('spi.event.tgj.gruppe', {
                url: '/gruppen/:gruppeid',
                templateUrl: 'templates/event/tgj/gruppen/gruppe/gruppe.html',
                controller: GruppeController,
                controllerAs: 'vm',
                resolve: {
                    aktiveGruppe: function (aktivesEvent, gruppe, $stateParams) {
                        return gruppe.getBySlugOrID($stateParams.gruppeid);
                    },
                    spiele: function (aktivesEvent, spiel, aktiveGruppe) {
