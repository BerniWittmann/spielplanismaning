(function () {
    ...
    describe('Component: Gruppen-Panel', function () {
        beforeEach(module('spi.gruppen.gruppenpanel.ui'));
        ...
        it('die Teams sollen einen Link auf die entsprechende Team-Seite haben', function () {
            ...
            expect(angular.element(result[0]).html()).to.contain('data-ui-sref="spi.tgj.team({teamid: team._id})"');
            expect(angular.element(result[1]).html()).to.contain('data-ui-sref="spi.tgj.team({teamid: team._id})"');
            expect(angular.element(result[2]).html()).to.contain('data-ui-sref="spi.tgj.team({teamid: team._id})"');
        });
    });
}());
